...
export const metadata: Metadata = {
  title: "JEE Main College Predictor (NITs, IIITs & GFTIs by JoSAA Cutoffs) | StudentTools",
  description: "Find NIT, IIIT, and GFTI admission chances for your JEE Main rank based on official JoSAA counselling closing ranks.",
  alternates: {
