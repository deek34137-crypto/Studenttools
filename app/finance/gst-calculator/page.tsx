...
export const metadata: Metadata = {
  title: "GST Calculator India (Inclusive & Exclusive with CGST/SGST Breakdown) | StudentTools",
  description: "Calculate Indian GST instantly. Supports GST inclusive and exclusive modes with automatic 50:50 CGST and SGST bifurcation.",
  alternates: {
    canonical: 'https://studenttools.cyou/finance/gst-calculator',
  },
  openGraph: {
    title: "GST Calculator India (Inclusive & Exclusive with CGST/SGST Breakdown) | StudentTools",
    description: "Calculate Indian GST instantly. Supports GST inclusive and exclusive modes with automatic 50:50 CGST and SGST bifurcation.",
    url: 'https://studenttools.cyou/finance/gst-calculator',
